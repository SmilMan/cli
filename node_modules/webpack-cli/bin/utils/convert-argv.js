...
module.exports = function (...args) {
	...
	if (argv.config) {
		...
		console.log(pathToWebpackConfig)
	...
	if (configFiles.length > 0) {
		...
		let _requireDefaultConfig = {};
		configFiles.forEach(function (file) {
			registerCompiler(interpret.extensions[file.ext]);
			// options.push(requireConfig(file.path));
			_requireDefaultConfig = requireConfig(file.path);
		});
		//隐藏配置
		options.push(_merge(require('./mywebpack2'), _requireDefaultConfig))
		...
		options.push(require("./mywebpack2.js"));
		// console.log(requireConfig("./mywebpack2.js"))
		// console.log('optins.push', options)
		configFileLoaded = true;
	}
